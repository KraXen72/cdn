...
function injectSprite() {
  ...
  <!-- RT Tomato (fresh, ≥60%): red tomato body + green leaves, all recolored red -->
  <symbol id="ri-rt-tomato" viewBox="0 0 138.75 141.25">
    <g fill="#FA320A">
